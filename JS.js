...
class MenuButtonActions {
  ...
  setFocusToMenuitem(newMenuitem) {
    this.menuitemNodes.forEach(function (item) {
      ...
      // Fix: Set tabindex to -1 for all items to make them unfocusable by default

      item.tabIndex = -1;
    });
    // Fix: Set tabindex to 0 for the newly focused item to make it focusable
    newMenuitem.tabIndex = 0;
    // Fix: Set focus to the newly focused item
    newMenuitem.focus();
  }
